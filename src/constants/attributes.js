...
export const attributes = [
    ...
    { label: "border-left-style", value: "border-left-style", type: OptionSelect },
    ...
    { label: "border-right-style", value: "border-right-style", type: OptionSelect },
    { label: "border-right-color", value: "border-right-color", type: OptionColor },
    { label: "border-top-width", value: "border-top-width", type: Option },
    { label: "border-top-style", value: "border-top-style", type: OptionSelect },
